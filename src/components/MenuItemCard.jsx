...
export default function MenuItemCard({menuItemObj, addOrder}) {
    ...
    return(
        <div className="menu-item-card">
            ...
            {menuItemObj.defaultPrice?<p>${menuItemObj.defaultPrice}</p>: <p>Small ${menuItemObj.sizes.small.price} Medium ${menuItemObj.sizes.medium.price} Large ${menuItemObj.sizes.large.price} </p>}
            {menuItemObj.isAvailable? <button className="menu-cart-btn"
            onClick={()=>{addOrder(menuItemObj)}}>Order</button>: <h5 className="unavailable-message">Currently Unavailable</h5>}
